...
int ComputeNewPolarizationEnergy(int New,int excl_ads,int excl_cation)
{
	...
	if((BackPolarization)||(Framework[CurrentSystem].FrameworkModel==FLEXIBLE))
	{
		for(f1=0;f1<Framework[CurrentSystem].NumberOfFrameworks;f1++)
		{
			for(i=0;i<Framework[CurrentSystem].NumberOfAtoms[f1];i++)
			{
				...
				Framework[CurrentSystem].Atoms[f1][i].ElectricField.y=0.0;
				Framework[CurrentSystem].Atoms[f1][i].ElectricField.z=0.0;
				Framework[CurrentSystem].Atoms[f1][i].InducedDipole.x=pol_factor*electric_field.x;
				Framework[CurrentSystem].Atoms[f1][i].InducedDipole.y=pol_factor*electric_field.y;
				Framework[CurrentSystem].Atoms[f1][i].InducedDipole.z=pol_factor*electric_field.z;
			}
		}
	}
	...
	for(i=0;i<NumberOfAdsorbateMolecules[CurrentSystem];i++)
	{
		for(j=0;j<Adsorbates[CurrentSystem][i].NumberOfAtoms;j++)
		{
			...
			Adsorbates[CurrentSystem][i].Atoms[j].ElectricField.y=0.0;
			Adsorbates[CurrentSystem][i].Atoms[j].ElectricField.z=0.0;
			Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.x=pol_factor*electric_field.x;
			Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.y=pol_factor*electric_field.y;
			Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.z=pol_factor*electric_field.z;
		}
	}
	...
	for(i=0;i<NumberOfCationMolecules[CurrentSystem];i++)
	{
		for(j=0;j<Cations[CurrentSystem][i].NumberOfAtoms;j++)
		{
			...
			Cations[CurrentSystem][i].Atoms[j].ElectricField.y=0.0;
			Cations[CurrentSystem][i].Atoms[j].ElectricField.z=0.0;
			Cations[CurrentSystem][i].Atoms[j].InducedDipole.x=pol_factor*electric_field.x;
			Cations[CurrentSystem][i].Atoms[j].InducedDipole.y=pol_factor*electric_field.y;
			Cations[CurrentSystem][i].Atoms[j].InducedDipole.z=pol_factor*electric_field.z;
		}
	}
	...
	if(New)
	{
		for(i=0;i<Components[CurrentComponent].NumberOfAtoms;i++)
		{
			...
			ElectricFieldAtTrialPosition[CurrentSystem][i].y=0.0;
			ElectricFieldAtTrialPosition[CurrentSystem][i].z=0.0;
			InducedDipoleAtTrialPosition[CurrentSystem][i].x=pol_factor*electric_field.x;
			InducedDipoleAtTrialPosition[CurrentSystem][i].y=pol_factor*electric_field.y;
			InducedDipoleAtTrialPosition[CurrentSystem][i].z=pol_factor*electric_field.z;
		} 
	}
	...
	for(k=0;k<NumberOfBackPolarizationSteps;k++)
	{
			...
			for(f1=0;f1<Framework[CurrentSystem].NumberOfFrameworks;f1++)
			{
				if(Framework[CurrentSystem].FrameworkModels[f1]==FLEXIBLE)
				{
					for(i=0;i<Framework[CurrentSystem].NumberOfAtoms[f1];i++)
					{
						...
						Framework[CurrentSystem].Atoms[f1][i].InducedDipole.x=pol_factor*(electric_field1.x+electric_field2.x);
						Framework[CurrentSystem].Atoms[f1][i].InducedDipole.y=pol_factor*(electric_field1.y+electric_field2.y);
						Framework[CurrentSystem].Atoms[f1][i].InducedDipole.z=pol_factor*(electric_field1.z+electric_field2.z);
					}
				}
			}
		}
		...
		for(i=0;i<NumberOfAdsorbateMolecules[CurrentSystem];i++)
		{
			for(j=0;j<Adsorbates[CurrentSystem][i].NumberOfAtoms;j++)
			{
				...
				Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.x=pol_factor*(electric_field1.x+electric_field2.x);
				Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.y=pol_factor*(electric_field1.y+electric_field2.y);
				Adsorbates[CurrentSystem][i].Atoms[j].InducedDipole.z=pol_factor*(electric_field1.z+electric_field2.z);
			}
		}
		...
		for(i=0;i<NumberOfCationMolecules[CurrentSystem];i++)
		{
			for(j=0;j<Cations[CurrentSystem][i].NumberOfAtoms;j++)
			{
				...
				Cations[CurrentSystem][i].Atoms[j].InducedDipole.x=pol_factor*(electric_field1.x+electric_field2.x);
				Cations[CurrentSystem][i].Atoms[j].InducedDipole.y=pol_factor*(electric_field1.y+electric_field2.y);
				Cations[CurrentSystem][i].Atoms[j].InducedDipole.z=pol_factor*(electric_field1.z+electric_field2.z);
			}
		}
		if(New)
		{
			for(i=0;i<Components[CurrentComponent].NumberOfAtoms;i++)
			{
				...
				InducedDipoleAtTrialPosition[CurrentSystem][i].x=pol_factor*(electric_field1.x+electric_field2.x);
				InducedDipoleAtTrialPosition[CurrentSystem][i].y=pol_factor*(electric_field1.y+electric_field2.y);
				InducedDipoleAtTrialPosition[CurrentSystem][i].z=pol_factor*(electric_field1.z+electric_field2.z);
			}
		}
	}
...
int TranslationMoveAdsorbate(void)
{
	...
	d=(int)(RandomNumber()*(REAL)Components[CurrentComponent].NumberOfMolecules[CurrentSystem]);
	...
	// Check if moving into an accessible part of the grid
	if (UseDelaunayGrid) 
	{
		for(i=0;i<nr_atoms;i++)
		{
			Testpoint = InterpolateDelaunayGrid(Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Atoms[i].Type, TrialPosition[CurrentSystem][i]);
			if (Testpoint > 0.5)
				return 0;
		}
	}
	if (UseDynamicGrid) {
		for(i=0;i<nr_atoms;i++)
		{
			Testpoint = InterpolateDynamicGrid(TrialPosition[CurrentSystem][i]);
			if (Testpoint > 0.5 && Testpoint != Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Grid)
				return 0;
		}
	}
	...
	if(RandomNumber()<BiasingWeight*exp(-Beta[CurrentSystem]*DeltaU))
	{
		...
		for(i=0;i<nr_atoms;i++)
		{
			if (DynamicGrid) 
			{
				...
				AdjustDynamicGrid(Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Grid,Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Atoms[i].Type,TrialPosition[CurrentSystem][i]);
			}
...
int RandomTranslationMoveAdsorbate(void)
{
	...
	displacement.z=(RandomNumber()-0.5)*Box[CurrentSystem].bz;
...
int RandomTranslationMoveCation(void)
{
	...
	// calculate a random displacement
	displacement.x=(RandomNumber()-0.5)*Box[0].ax;
	displacement.y=(RandomNumber()-0.5)*Box[0].by;
	displacement.z=(RandomNumber()-0.5)*Box[0].bz;
...
int IdentityChangeAdsorbateMove(void)
{
	...
	if(Components[OldComponent].NumberOfMolecules[CurrentSystem]==0) return 0;
	
	// choose a random molecule of the 'Old'-component
	d=(int)(RandomNumber()*(REAL)Components[OldComponent].NumberOfMolecules[CurrentSystem]);
	count=-1;
	CurrentCationMolecule=-1;
	CurrentAdsorbateMolecule=-1;
	do   // search for d-th molecule of the right type
		if(Adsorbates[CurrentSystem][++CurrentAdsorbateMolecule].Type==OldComponent) count++;
	while(d!=count);
								  ...
								  ((REAL)Components[NewComponent].NumberOfMolecules[CurrentSystem]+(REAL)1.0))))
	{
		...
		for(i=0;i<nr_atoms;i++)
		{
			...
			NumberOfPseudoAtomsType[CurrentSystem][type]++;
			if (DynamicGrid) {
				AdjustDynamicGrid(Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Grid,Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Atoms[i].Type,Adsorbates[CurrentSystem][CurrentAdsorbateMolecule].Atoms[i].Position);
			}		
		}
...
int IdentityChangeCationMove(void)
{
	...
	CurrentAdsorbateMolecule=-1;
	do   // search for d-th molecule of the right type
		if(Cations[CurrentSystem][++CurrentCationMolecule].Type==OldComponent) count++;
	while(d!=count);
...
int GibbsParticleTransferAdsorbateMove(void)
{
	...
	if(Components[CurrentComponent].NumberOfMolecules[B]==0) return 0;
					   ...
					   (RosenbluthOld*((REAL)(1.0+Components[CurrentComponent].NumberOfMolecules[A]))*Volume[B])))
	{
		...
		if(ChargeMethod!=NONE)
		{
			...
			//NetChargeAdsorbates[CurrentSystem]+=NetChargeAdsorbateDelta[CurrentSystem];
			if((ChargeMethod==EWALD)&&(!OmitEwaldFourier))
		...
		if(ChargeMethod!=NONE)
		{
			...
			//NetChargeAdsorbates[CurrentSystem]+=NetChargeAdsorbateDeltaOld;
